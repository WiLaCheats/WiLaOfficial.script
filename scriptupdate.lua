...
norec = 0xFD9E00 --applyrecoil
sprd = 0xFD9D08 --updatespread
aimpnch = 0xFD9F1C --applyaimpunch.
speeds = 0xFD9990 --getcurrentmaxspeed
hdrai = 0xA85154 --raycastcharacter
byrai = 0xA85154 --raycastcharacter
noflsh = 0xA7CEDC --raycastgrenade
nosmk = 0xC53540 --ExplodeGrenade
wollbng = 0xA84C00 --processhitbuffer
